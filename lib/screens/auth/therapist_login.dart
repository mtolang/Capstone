...
import '../../helper/therapist_auth.dart';
...
class _TherapistLoginState extends State<TherapistLogin> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      final result = await TherapistAuthService.signInTherapist(
        email: _emailController.text,
        password: _passwordController.text,
      );

      if (mounted && result != null) {
        final therapistData = result['therapistData'] as Map<String, dynamic>;
        final therapistId = result['therapistId'] as String;

        // Get therapist name from different possible field names
        ...
        _showSuccessMessage('Welcome back, $therapistName! (ID: $therapistId)');
  ...
  Future<void> _handleForgotPassword() async {
    ...
    try {
      await TherapistAuthService.resetPassword(email: _emailController.text);
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            if (!TherapistAuthService.isValidEmail(value)) {
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          validator: (value) {
                            ...
                            // Remove the length restriction - accept any password
                            return null;
                          },
                        ),
                      ),
