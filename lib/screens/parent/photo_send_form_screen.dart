  ...
  Future<void> _loadMaterials() async {
    try {
      ...
      if (materials.isNotEmpty) {
        print(
            'Child ID: $_childId, Child Name: $_childName, Clinic ID: $_clinicId');
      }
    } catch (e) {
  ...
  Future<void> _sendPhoto() async {
    if (_selectedMaterial == null || _selectedMaterialData == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content:
              Text('Please select a material to associate with this photo'),
                  ...
                  child: SafeArea(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: _isSending || _selectedMaterial == null
                            ? null
                            : _sendPhoto,
